...
export const TRACKS_EXAMPLES: TrackExample[] = [
  {
    ...
    name: "Beats",
    artist: "Loksii",
    fileSrc: `${import.meta.env.BASE_URL}tracks/beats-loksii.mp3`,
  ...
  },
  {
    ...
    artist: "Alex Morgan",
    fileSrc: `${import.meta.env.BASE_URL}tracks/meditation-spiritual-alex-morgan.mp3`,
    // originalSrc:
  ...
  },
  {
    ...
    name: "Funk",
    artist: "Moodmode",
    fileSrc: `${import.meta.env.BASE_URL}tracks/funk-moodmode.mp3`,
